package cl.claveles.terreno.eip;

import cl.claveles.terreno.eip.enricher.EnTerrenoNuevosSociosEnricher;
import cl.claveles.terreno.eip.pipeline.Mensaje;
import cl.claveles.terreno.eip.pipeline.Tuberia;
import cl.claveles.terreno.eip.translator.EnTerrenoNuevosSociosTranslator;
import jakarta.jms.*;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        tuberia.addProcesador( new EnTerrenoNuevosSociosTranslator() );
        tuberia.addProcesador( new EnTerrenoNuevosSociosEnricher() );

        String brokerUsuario = "claveles";
        String brokerPassword = "Fundacion25..";

        procesarMensajesJMS(
                "colas/enTerrenoNuevosSocios",
